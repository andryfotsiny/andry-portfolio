                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          ...
                          <Terminal className="w-3 h-3" />
                                        ...
                                        {(project.githubUrl || project.liveUrl) && (
                                            <div className="flex gap-3 mt-4 pt-4 border-t border-neon-blanc/10">
                                                {project.githubUrl && (
                                                    <a
                                                        href={project.githubUrl}
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className="flex items-center gap-2 px-3 py-2 bg-dark-gray hover:bg-dark-gray/70 rounded-lg transition-colors text-sm text-neon-blanc"
                                                    >
                                                ...
                                                {project.liveUrl && (
                                                    <a
                                                        ...
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className="flex items-center gap-2 px-3 py-2 bg-neon-blue/20 hover:bg-neon-blue/30 rounded-lg transition-colors text-sm text-neon-blue"
                                                    >
